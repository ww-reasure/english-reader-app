...
更新时间：2026-08-30（底层性能优化与平板适配实施后）
...
- 当前工作分支：`feat/english-practice-machine`，HEAD 与本地 `private/main` 都是 `77018fa09b921e9a0b58146a627221a1fc625a25`（本轮收口未做任何提交）。
- 当前工作树包含"性能与复习可靠性收口"、四轮审查修复、底层性能优化及平板适配的全部未提交变更；未切分支、未 reset、未推送，用户原有修改完整保留。实施记录见 `docs/superpowers/plans/2026-08-29-app-performance-review-reliability.md`。
- 应用版本：`2.0.0`，Android `versionCode=47`。
...
1. 先在真实平板安装 versionCode 47 稳定版 APK，覆盖竖横屏旋转、系统分屏/自由窗口、软键盘遮挡、阅读侧栏、20 词复习、真题双栏、外接键盘焦点和系统返回键；记录任何页面、方向和操作步骤明确的异常。
