...
export const AppShell = {
  ...
  _updateShell(meta, pageMode, hash) {
    ...
    shell.className = `app-shell app-shell--${pageMode} app-shell--${meta.tabletLayout || 'rail'} app-shell--${headerMode === 'back' ? 'back' : 'root'}${isVocabularyHome ? ' app-shell--vocab' : ''}${isSettings ? ' app-shell--settings' : ''}${meta.navKey === 'exam' ? ' app-shell--exam' : ''}${hash === '#/exam' ? ' app-shell--exam-home' : hash.startsWith('#/exam/catalog/') ? ' app-shell--exam-catalog' : ''}`;
